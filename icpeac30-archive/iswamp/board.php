...
<span class="current">ADVISORY BOARD</span>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href='https://www.griffith.edu.au/science-aviation/school-natural-sciences'>School of Natural Sciences</a></td>
            ...
            <td align="left" valign="top" class="content"><h1>Advisory Board</h1>
              
<ul>
<li>Robert Moshammer (Germany), chair</li>
<li>Lorenzo Avaldi (Italy)</li>
<li>John Bozek (USA)</li>
<li>Carlo Callegari (Italy)</li>
<li>John Costello (Ireland)</li>
<li>Lou Dimauro (USA)</li>
<li>Dajun Ding (China)</li>
<li>Alexei Grum-Grzhimailo (Russia)</li>
<li>Michael Meyer (Germany)</li>
<li>Artem Rudenko (USA)</li>
<li>Robin Santra (Germany)</li>
<li>Antony Starace (USA)</li>
<li>Kiyoshi Ueda (Japan)</li>
</ul>
             </td>
          </tr>
          <tr>
